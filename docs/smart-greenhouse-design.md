...
> **Оглавление.** Полное описание системы разбито на пять документов. Этот файл сохранён для
  обратной совместимости со ссылками из репозитория.
...
**Соглашения об именовании:** ESP32 №1 — `greenhouse-watering`, №2 — `greenhouse-climate`; префикс
сущностей HA — `greenhouse_*`.

---

*Документ подготовлен для проекта smart-greenhouse. Перед монтажом сверьте GPIO, I2C‑адреса и
калибровку расходомеров на стенде.*
