...
**Монтаж:** крепить концевик так, чтобы рычаг форточки **нажимал** переключатель только в крайнем положении. Проводка — в FTP‑кабеле вместе с питанием серво (отдельная пара на каждый концевик: сигнал + GND). Подтяжка — `INPUT_PULLUP` в ESPHome, `inverted: true` (как контактные уровни бака на ESP32 №1).
