...
```
[Кран] ──► [Клапан бака GPIO27] ──► [YF-S201 GPIO14] ──► [Бак + уровни + DS18B20]
                                                              │
                                                              ▼
...
| 4 | Бак | GPIO16 → `tank_level_upper`, GPIO17 → `tank_level_middle`, нижний контакт → GND | Накопитель; гистерезис между средним и верхним уровнями |
